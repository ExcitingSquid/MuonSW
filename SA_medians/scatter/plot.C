...
void plot::Loop()
{
   ...
   TH2F *dphi_dist = new TH2F("","",1000,0,200,1000,-0.3,0.3);
   TH2F *deta_dist = new TH2F("","",1000,0,200,1000,-0.3,0.3);
...
//// case 2: using beam spot (BS and D1, D2,...)	 nth_SW = 7, 8, 9, 10 
 ...
 //  median_fitFunc->SetParLimits(4,-0.000001,0.000001);
   ...
   double x1[190], y1[190], x2[190], y2[190];
...
//   Draw_draw_dphi(median_fitFunc, dphi_dist[i][j], i, j);
   ...
   if(eta_or_phi == 1) c1->SaveAs("plots/deta_pix_pix_sw_"+nth_SW_+"_region_"+Region_+".png");
   if(eta_or_phi == 2) c1->SaveAs("plots/dphi_pix_pix_sw_"+nth_SW_+"_region_"+Region_+".png");
